import { GET_ORDER_QUERY, GET_MINIMAL_ORDERS_QUERY, GET_ORDERS_BY_ID_QUERY } from "./queries";
 ...
 */
export { GET_ORDER_QUERY, GET_MINIMAL_ORDERS_QUERY, GET_ORDERS_BY_ID_QUERY };
